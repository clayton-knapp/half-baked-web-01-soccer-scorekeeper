...
test('Test if renderTeam, given a name and score, returns a HTML div with p tags with the team name and score', (expect) => {
    ...
    const expected1 = '<div><p>Red</p><p>1</p></div>';
    ...
    //Expect
    // Make assertions about what is expected versus the actual result
    expect.equal(actual1.outerHTML, expected1, 'Feeds renderTeam Red and 1 and returns the outerHTML (string) of div "<div><p>Red</p><p>1</p></div>"');
    ...
    const expected2 = '<div><p>Dems</p><p>2</p></div>';
    ...
    //Expect
    // Make assertions about what is expected versus the actual result
    expect.equal(actual2.outerHTML, expected2, 'Feeds renderTeam Dems and 2 and returns the outerHTML (string) of div "<div><p>Dems</p><p>2</p></div>"');
